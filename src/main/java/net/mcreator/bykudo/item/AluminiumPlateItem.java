...
public class AluminiumPlateItem extends BykudoModElements.ModElement {
	@ObjectHolder("bykudo:aluminium_plate")
	public static final Item block = null;
	public AluminiumPlateItem(BykudoModElements instance) {
		super(instance, 30);
	}
