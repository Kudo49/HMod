...
public class SteelplateItem extends BykudoModElements.ModElement {
	@ObjectHolder("bykudo:steelplate")
	public static final Item block = null;
	public SteelplateItem(BykudoModElements instance) {
		super(instance, 45);
	}
