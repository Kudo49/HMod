...
public class CpIngotItem extends BykudoModElements.ModElement {
	@ObjectHolder("bykudo:cp_ingot")
	public static final Item block = null;
	public CpIngotItem(BykudoModElements instance) {
		super(instance, 5);
	}
