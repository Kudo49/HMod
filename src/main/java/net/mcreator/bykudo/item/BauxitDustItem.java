...
public class BauxitDustItem extends BykudoModElements.ModElement {
	@ObjectHolder("bykudo:bauxit_dust")
	public static final Item block = null;
	public BauxitDustItem(BykudoModElements instance) {
		super(instance, 11);
	}
